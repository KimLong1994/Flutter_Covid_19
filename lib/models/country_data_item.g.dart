...
part of 'country_data_item.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

CountryDataItem _$CountryDataItemFromJson(Map<String, dynamic> json) {
  return CountryDataItem(
    updated: json['updated'] as int,
    country: json['country'] as String,
    countryInfo: json['countryInfo'] == null
        ? null
        : CountryDataInfoItem.fromJson(
...
Map<String, dynamic> _$CountryDataItemToJson(CountryDataItem instance) =>
    <String, dynamic>{
